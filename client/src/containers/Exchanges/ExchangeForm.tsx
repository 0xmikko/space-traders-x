            ...
            <div className={"exchange-card"}>
                ...
                <Row>
                    ...
                    <Col sm={3}>
                        ...
                        <Input type="select" value={sellResourceType} onChange={event => setSellResourceType(event.target.value)}>
                ...
                <Row>
                    ...
                    <Col sm={3}>
                        <div className={"exchange-card-select"}>
                        <Input type="select" value={buyResourceType} onChange={event => setBuyResourceType(event.target.value)}>
                            <option  value="0">Gold</option>
                            <option value="1">Fuel</option>
                            <option value="2">Metal</option>
                        </Input>
